...
from constants import TEXT_NAME, N_CHAPTERS
...
for chapter_num in range(1, N_CHAPTERS + 1):
    ...
    for lemma in sorted(chapter_lemma_count.keys()
                        ...
                        key=coll.sort_key):
        lemma_data = {}
        lemma_data["cumulative_last_seen"] = cumulative_lemma_last_seen.get(
            lemma, 0)
        ...
        for form in cumulative_lemma_form_count[lemma].keys(
            ...
            form_data[
                "cumulative_lemma_form_count"] = cumulative_lemma_form_count[
                    lemma][form]
            form_data["chapter_lemma_form_count"] = chapter_lemma_form_count[
                lemma][form]
